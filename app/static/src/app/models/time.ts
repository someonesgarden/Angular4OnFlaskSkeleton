...
export class NobelTime{
  ...
  init(): void {
    ...
    let chartHolder: any = d3.select('#nobel-time');
    ...
    this.svg = chartHolder.append("svg")
    ...
    // AXIS
    var xAxis = d3.axisBottom(this.xScale).tickValues(this.xScale.domain().filter(function(d,i) {return !(d%10);}));
